 ...
 *   The form state.
 */
function bootstrapbusiness_form_system_theme_settings_alter(&$form, &$form_state) {
    ...
    $form['mtt_settings']['tabs']['basic_settings']['breadcrumb_display'] = array(
        ...
        '#default_value' => theme_get_setting('breadcrumb_display','bootstrapbusiness'),
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
        ...
        '#default_value' => theme_get_setting('scrolltop_display', 'bootstrapbusiness'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['bootstrap_js_include'] = array(
        ...
        '#default_value' => theme_get_setting('bootstrap_js_include', 'bootstrapbusiness'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['mtt_settings']['tabs']['ie8_support']['responsive_respond'] = array(
        '#type' => 'checkbox',
        '#title' => t('Add Respond.js [<em>bootstrapbusiness/js/respond.min.js</em>] JavaScript to add basic CSS3 media query support to IE 6-8.'),
        '#default_value' => theme_get_setting('responsive_respond','bootstrapbusiness'),
